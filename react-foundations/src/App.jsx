...
function App() {
  ...
  return (
    <>
      <h1 className="text-white text-4xl p-10 underline text-center">
        Video Games
      </h1>

      {/* Render ...bring in the Product component, giving the props values */}
      <div className="products-container bg-white flex flex-col justify-center items-center p-20 gap-10">
        <Product
          name="Call of Duty"
